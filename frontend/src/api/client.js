...
// Wrapper fino sobre fetch — mesmo padrão do SIGA (ver SIGA/frontend/src/api/client.js).
export async function apiFetch(path, { skipAuthRedirect = false, ...options } = {}) {
  ...
  // definir o Content-Type sozinho (com o boundary do multipart); se a
  // gente forçar "application/json" aqui, o backend não consegue ler o
  // corpo da requisição.
